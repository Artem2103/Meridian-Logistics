...
export const FEATURES = [
  ...
  },
  {
    ...
    desc: "Different goods face different rules. Koda knows which corridors, ports, and borders are open for your specific cargo — from perishables to controlled materials.",
  },
  {
    num: "03",
...
// ─── TEAM ─────────────────────────────────────────────────────────────────────
export const TEAM = [
  { name: "Artem Lyutyi",    role: "CEO & Co-founder",        bio: "Former Head of Freight at Fortnite. 14 years routing complex international cargo across sanctioned and conflict zones." },
...
export const SYSTEMS_FEATURES = [
  ...
  },
  {
    ...
    desc: "For a given product and volume, Koda ranks sourcing countries by total cost, lead time, quality risk, and geopolitical stability. Make sourcing decisions on evidence.",
  },
  {
