...
export const translations = {
    en: {
      ...
      hero: {
        ...
        h1Line1:      "Do business",
        h1Line2:      "smarter.",
        sub:          "Koda's AI finds the fastest, cheapest, and safest international trade routes for your specific goods — accounting for customs rules, sanctions, port conditions, and geopolitical risk in real time.",
      ...
      map: {
        home: {
          ...
          sub:      "Koda covers every major trade lane on earth — from high-volume container routes to narrow-gauge emerging market corridors. If cargo moves there, we model it.",
        },
        logistics: {
      ...
      features: {
        ...
        items: [
          ...
          { num: "02", title: "Product-aware Routing",     desc: "Different goods face different rules. Koda knows which corridors, ports, and borders are open for your specific cargo — from perishables to controlled materials." },
      ...
      logistics: {
        ...
        howItWorks: {
          ...
          h2Line1:  "Your cargo,",
          h2Line2:  "your rules.",
          p1:       "Enter your product, origin, destination, and volume. Koda cross-references commodity-specific trade rules, live port conditions, and carrier performance to return ranked route options in seconds.",
      ...
      systems: {
        ...
        whyItMatters: {
          ...
          p2:       "Koda Systems calculates every layer before you sign anything — so you negotiate supplier prices knowing your real margin, not an estimate.",
        },
        costMockup: {
        ...
        features: [
          ...
          { title: "Supplier Country Analytics",  desc: "For a given product and volume, Koda ranks sourcing countries by total cost, lead time, quality risk, and geopolitical stability. Make sourcing decisions on evidence." },
      ...
      securities: {
        ...
        whyItMatters: {
          ...
          p1:       "Sanctions violations, cargo seizures, and force majeure events are rarely surprises — they're predictable risks that weren't flagged in time. Koda Securities changes that.",
        ...
        realScenarios: {
          ...
          cols: { scenario: "Scenario", risk: "Risk identified", action: "Koda's action" },
          examples: [
            {
      ...
      pricing: {
        ...
        faqs: [
          {
            q: "How does Koda know which routes are restricted for my product?",
          ...
          {
            q: "Can Koda integrate with our existing ERP or TMS?",
      ...
      about: {
        ...
        sub:        "Koda was founded in Hanoi in 2020 by a solo founder. I spent years watching cargo fail for predictable reasons — wrong routes, missed restrictions, unseen risk. I built the tool people always needed.",
    ...
    ru: {
      ...
      hero: {
        ...
        h1Line2:      "умнее.",
        sub:          "ИИ Koda находит самые быстрые, дешёвые и безопасные международные торговые маршруты для ваших конкретных товаров — с учётом таможенных правил, санкций, состояния портов и геополитических рисков в реальном времени.",
      ...
      map: {
        home: {
          ...
          sub:      "Koda охватывает все основные торговые маршруты на Земле — от высокообъёмных контейнерных линий до коридоров развивающихся рынков. Если груз туда движется — мы его моделируем.",
        },
        logistics: {
      ...
      features: {
        ...
        items: [
          ...
          { num: "02", title: "Маршрутизация с учётом товара", desc: "Разные товары подчиняются разным правилам. Koda знает, какие коридоры, порты и границы открыты для вашего груза — от скоропортящихся до подконтрольных материалов." },
      ...
      logistics: {
        ...
        sub:          "Движок маршрутов Koda оценивает каждый возможный путь для вашего груза — по всем видам транспорта, границам и торговым режимам — и ранжирует их по стоимости, скорости и риску. Без догадок.",
        howItWorks: {
          eyebrow:  "Как это работает",
          h2Line1:  "Ваш груз,",
          h2Line2:  "ваши правила.",
          p1:       "Введите товар, происхождение, назначение и объём. Koda сопоставляет товарные торговые правила, актуальные условия в портах и показатели перевозчиков, чтобы за секунды предоставить ранжированные варианты маршрутов.",
      ...
      systems: {
        ...
        sub:          "Koda Systems предоставляет полную финансовую картину любого торгового маршрута — пошлины, налоги, сборы за обработку, валютные риски и сравнение поставщиков — ещё до размещения первого заказа.",
        whyItMatters: {
          ...
          p2:       "Koda Systems рассчитывает каждый уровень затрат до подписания любых договорённостей — чтобы вы вели переговоры с поставщиками, зная реальную маржу, а не приблизительную оценку.",
        },
        costMockup: {
        ...
        features: [
          ...
          { title: "Аналитика стран-поставщиков",             desc: "Для данного товара и объёма Koda ранжирует страны-поставщики по совокупным затратам, срокам, качественным рискам и геополитической стабильности." },
      ...
      securities: {
        ...
        sub:          "Koda Securities в реальном времени отслеживает санкционные списки, геополитические сигналы и риски коридоров — и сообщает вам точные действия ещё до того, как груз окажется в воздухе.",
        whyItMatters: {
          eyebrow:  "Почему это важно",
          h2Line1:  "Одно решение о маршруте",
          h2Line2:  "может стоить всего.",
          p1:       "Нарушения санкций, арест грузов и форс-мажор редко бывают неожиданностью — это предсказуемые риски, которые не были выявлены вовремя. Koda Securities меняет это.",
        ...
        realScenarios: {
          ...
          cols: { scenario: "Сценарий", risk: "Выявленный риск", action: "Действие Koda" },
          examples: [
            {
              ...
              action:   "Koda отмечает код ТН ВЭД, запрашивает данные лицензии и предлагает альтернативный маршрут через Сингапур с меньшей степенью контроля.",
            },
            {
              ...
              action:   "Koda рекомендует южный коридор, обновляет перечень документов и предупреждает о новом двустороннем фитосанитарном протоколе.",
            },
            {
              ...
              action:   "Koda отмечает банк, приостанавливает рекомендацию и предлагает три соответствующие требованиям альтернативы для корреспондентского банкинга.",
            },
          ],
        },
        deptCTA: {
      ...
      pricing: {
        ...
        faqs: [
          {
            q: "Откуда Koda знает, какие маршруты ограничены для моего товара?",
          ...
          {
            q: "Может ли Koda интегрироваться с нашей существующей ERP или TMS?",
      ...
      about: {
        ...
        sub:        "Koda была основана в Ханое в 2020 году единственным основателем. Я годами наблюдал за тем, как грузы терпят неудачу по предсказуемым причинам — неправильные маршруты, пропущенные ограничения, скрытые риски. Я создал инструмент, который всегда был нужен людям.",
