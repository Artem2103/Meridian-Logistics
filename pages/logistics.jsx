  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ marginLeft: 8, fontFamily: "monospace", fontSize: 9, color: "var(--panel-text-3)", letterSpacing: "0.06em" }}>Fresh produce · 20ft container</span>
      </div>

      <div style={{ padding: "20px" }}>
        <div style={{ fontSize: 9, letterSpacing: "0.14em", color: "var(--panel-text-3)", marginBottom: 14 }}>SUGGESTED ROUTES</div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {routes.map((r) => (
            <div key={r.rank} style={{
              background: r.rank === 1 ? "rgba(255,255,255,0.08)" : "var(--panel-2)",
              border: `1px solid ${r.rank === 1 ? "rgba(255,255,255,0.2)" : "var(--panel-border)"}`,
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                <span style={{
                  ...
                  color: r.rank === 1 ? "var(--panel-text)" : "var(--panel-text-2)",
                }}>
                  #{r.rank} — via {r.via}
                </span>
                <span style={{
                  fontSize: 10, fontWeight: 700,
                  background: r.rank === 1 ? "#4ade80" : "rgba(255,255,255,0.08)",
                  color: r.rank === 1 ? "#000" : "var(--panel-text-3)",
              ...
              <div style={{ height: 2, background: "rgba(255,255,255,0.06)", borderRadius: 1, marginBottom: 8 }}>
                <div style={{
                  ...
                  background: r.rank === 1 ? "#4ade80" : "rgba(255,255,255,0.2)",
                  borderRadius: 1,
                }}/>
              </div>
              <div style={{ display: "flex", gap: 16 }}>
                <span style={{ fontSize: 11, color: "var(--panel-text-3)", fontFamily: "monospace" }}>{r.days} days</span>
                <span style={{ fontSize: 11, color: "var(--panel-text-2)", fontFamily: "monospace" }}>{r.cost}</span>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <p className="text-body-lg" style={{ maxWidth: 520, marginBottom: 48 }}>{sub}</p>
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
        ...
        <p className="text-body-lg" style={{ marginBottom: 40 }}>{sub}</p>
