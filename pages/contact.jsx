          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80 }}>
              ...
              {sent ? (
                <div style={{ animation: "fadeUp 0.4s ease both" }}>
                  ...
                  <p className="text-body" style={{ color: "var(--text-2)", lineHeight: 1.75 }}>
                    ...
                    <span style={{ color: "#fff" }}>{COMPANY_EMAIL}</span>
                  </p>
                </div>
              ) : (
            ...
            <div>
              <div style={{ marginBottom: 60 }}>
                <h3 style={{ fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 700, letterSpacing: "-0.015em", marginBottom: 18 }}>Enterprise sales</h3>
                <p className="text-body" style={{ color: "var(--text-2)", lineHeight: 1.8 }}>
